    ...
    # primero establecemos una conexion sin especificar la base de datos
        ...
        try:
            ...
            if err.errno == mysql.connector.errorcode. ER_BAD_DB_ERROR:
                ...
                raise err
        #una vez que la base esta estsblecida, creamos la tabla sino existe
...
catalogo = Catalogo(host='romulojgm.mysql.pythonanywhere-services.com', user='romulojgm', password='emmanu12',database='romulojgm$miapp')

#carpeta para guardar las imagenes
#ruta_destino = './Static/img/'
ruta_destino = '/home/romulojgm/mysite/Static/img/'
